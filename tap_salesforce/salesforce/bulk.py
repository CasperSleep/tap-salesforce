...
class Bulk():
    ...
    def check_bulk_quota_usage(self):
        ...
        # changing the response key in accordance with the docs
        # https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_limits.htm?search_text=limits
